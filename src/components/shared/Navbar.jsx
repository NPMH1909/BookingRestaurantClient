...
import SearchBarComponent from "../restaurants/SearchBarComponent";
...
function NavList() {
  ...
  return (
    ...
    {[
      ...
      { name: "Khuyến mãi", path: "/restaurants/promotions" },
      { name: "Góc Video", path: "/restaurants/introductions" },
      ...
      return (
        <Typography
          ...
          variant="h5"
          color="blue-gray"
          className={`relative font-semibold px-3 py-2 transition-colors text-gray-900
...
export const NavbarWithSublist = () => {
  ...
  return (
      ...
      <Navbar className="bg-[#F5F5DC] mx-auto max-w-screen-3xl border-0 rounded-none px-4 py-2 "  >
