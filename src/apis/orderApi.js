...
export const orderApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getOrdersByResId: builder.query({
      query: ({ restaurantId, page, size=8 }) => ({
        url: `/restaurant/${restaurantId}?page=${page}&limit=${size}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    getUserOrders: builder.query({
      query: ({page, limit = 8}) => ({
        url: `/order/user?page=${page}&limit=${limit}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    getCompletedOrders: builder.query({
      query: (restaurantId) => ({
        url: `/restaurant-conpleted/${restaurantId}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    getConfirmOrders: builder.query({
      query: (restaurantId) => ({
        url: `/restaurant-comfirm/${restaurantId}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    getOnHoldOrders: builder.query({
      query: (restaurantId) => ({
        url: `/restaurant-onhold/${restaurantId}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
